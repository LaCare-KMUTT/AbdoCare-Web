...
class ADLFormBody extends StatefulWidget {
  ADLFormBody({Key key}) : super(key: key);
  @override
  _ADLFormBodyState createState() => _ADLFormBodyState();
}

class _ADLFormBodyState extends State<ADLFormBody> {
      ...
      children: [
              ...
              children: [
                Expanded(
                  child: Container(
                    child: RadioListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('2 ตักอาหารและช่วยตัวเองได้เป็นปกติ'),
                      value: 2,
                      groupValue: feeding,
                      onChanged: (newValue) {
                        setState(() {
                          feeding = newValue;
                          score1 = 2;
                          _feeding = '2 ตักอาหารและช่วยตัวเองได้เป็นปกติ';
                          print(_feeding);
                        });
                      },
                    ),
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    child: RadioListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('0 ต้องการความช่วยเหลือ'),
                      value: 0,
                      groupValue: grooming,
                      onChanged: (newValue) {
                        setState(() {
                          grooming = newValue;
                          score2 = 0;
                          _grooming = '0 ต้องการความช่วยเหลือ';
                          print(_grooming);
                        });
                      },
                    ),
        ...
        Container(
          child: Padding(
            ...
            child: Row(
              children: [
                Expanded(child: Text('4. Toilet use (การใช้ห้องน้ำ)')),
              ],
            ),
          ),
        ),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Expanded(
                    child:
                        Text('5. Mobility (การเคลื่อนที่ภายในห้องหรือบ้าน)')),
              ],
            ),
          ),
        ),
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    child: RadioListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('0 เคลื่อนที่ไปไหนไม่ได้'),
                      value: 0,
                      groupValue: mobility,
                      onChanged: (newValue) {
                        setState(() {
                          mobility = newValue;
                          score5 = 0;
                          _mobility = '0 เคลื่อนที่ไปไหนไม่ได้';
                          print(_mobility);
                        });
                      },
                    ),
              ...
              children: [
                Expanded(
                  child: Container(
                    child: RadioListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('3 เดินหรือเคลื่อนที่ได้เอง'),
                      value: 3,
                      groupValue: mobility,
                      onChanged: (newValue) {
                        setState(() {
                          mobility = newValue;
                          score5 = 3;
                          _mobility = '3 เดินหรือเคลื่อนที่ได้เอง';
                          print(_mobility);
                        });
                      },
                    ),
        ...
        Container(
          child: Padding(
            ...
            child: Row(
              children: [
                Expanded(child: Text('6. Dressing (การสวมใส่เสื้อผ้า)')),
              ],
            ),
          ),
        ),
                    ...
                    child: RadioListTile(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          dressing = newValue;
                          score6 = 0;
                          _dressing = '0 ต้องการความช่วยเหลือ';
                          print(_dressing);
                        });
                      },
                    ),
        ...
        Container(
          child: Padding(
            ...
            child: Row(
              children: [
                Expanded(child: Text('7. Stairs (การขึ้นลงบันได1ชั้น)')),
              ],
            ),
          ),
        ),
        ...
        Container(
          child: Padding(
            ...
            child: Row(
              children: [
                Expanded(child: Text('8. Bathing (การอาบน้ำ)')),
              ],
            ),
          ),
        ),
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    child: RadioListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('0 ต้องมีคนช่วยหรือทำให้'),
                      value: 0,
                      groupValue: bathing,
                      onChanged: (newValue) {
                        setState(() {
                          bathing = newValue;
                          score8 = 0;
                          _bathing = '0 ต้องมีคนช่วยหรือทำให้';
                          print(_bathing);
                        });
                      },
                    ),
