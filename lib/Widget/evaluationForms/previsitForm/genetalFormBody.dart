...
class GeneralFormBody extends StatefulWidget {
  GeneralFormBody({Key key}) : super(key: key);
  @override
  _GeneralFormBodyState createState() => _GeneralFormBodyState();
}

class _GeneralFormBodyState extends State<GeneralFormBody> {
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกชื่อผู้ป่วย' : null;
                    },
                ...
                Expanded(
                    child: Text('Surname:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: TextFormField(
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกนามสกุลผู้ป่วย' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
                ...
                Expanded(child: Text('HN:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  child: TextFormField(
                    validator: (value) {
                ...
                Expanded(child: Text('AN:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  child: TextFormField(
                    validator: (value) {
        ...
        Container(
          child: Padding(
            ...
            child: Row(
              children: <Widget>[
                Expanded(
                    child: Text('Gender:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: DropdownButtonFormField(
                    isExpanded: true,
                    validator: (value) =>
                        value == null ? 'กรุณาเลือกเพศของผู้ป่วย' : null,
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
                        enabledBorder: OutlineInputBorder(
                ...
                Expanded(
                    flex: 1,
                    child: Text('Ward:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: DropdownButtonFormField(
                    isExpanded: true,
                ...
                Expanded(
                    flex: 2,
                    child:
                        Text('Date of Birth:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: Container(
                    width: 300,
                    child: DateTimeField(
                        ...
                        onShowPicker: (context, currentValue) {
                          ...
                          return date = _selectDate(context, currentValue);
                        },
                        onSaved: (date) {
                          setState(
                            () {
        ...
        Container(
          child: Padding(
            ...
            child: Row(
              children: <Widget>[
                Expanded(
                    child: Text('Diagnosis:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: TextFormField(
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกDiagnosis' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
                ...
                Expanded(
                    child: Text('Operation:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: TextFormField(
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกOperation' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
        ...
        Container(
          child: Padding(
            ...
            child: Row(
              children: <Widget>[
                Expanded(
                    flex: screenSize.height ~/ 400,
                    child: Text('Pre-medication',
                        style: TextStyle(fontWeight: FontWeight.w600))),
                Expanded(
                  flex: screenSize.height ~/ 150,
                  child: TextFormField(
                    keyboardType: TextInputType.multiline,
                    minLines: 1,
                    maxLines: 5,
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกPre-medication' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      title: Text('DM'),
                      value: 1,
                      groupValue: previousIllness,
                      onChanged: (newValue) {
                        setState(() {
                          previousIllness = newValue;
                          _previousIllness = 'DM';
                          print(_previousIllness);
                        });
                      },
                    ),
                  ),
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          previousIllness = newValue;
                          _previousIllness = 'Heart disease';
                          print(_previousIllness);
                        });
                      },
                    ),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('Hematologic abnormality'),
                      value: 6,
                      groupValue: previousIllness,
                      onChanged: (newValue) {
                        setState(() {
                          previousIllness = newValue;
                          _previousIllness = 'Hematologic abnormality';
                          print(_previousIllness);
                        });
                      },
                    ),
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          previousIllness = newValue;
                          _previousIllness = 'Renal diseasee';
                          print(_previousIllness);
                        });
                      },
                    ),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelText: 'Other'),
                    onSaved: (value) => _previousIllness = value,
                  ),
                ),
                Expanded(
                  flex: 3,
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    maxLines: 5,
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกDrug used' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
              ...
              children: <Widget>[
                Expanded(
                    ...
                    child: Text('Nutrition',
                        style: TextStyle(fontWeight: FontWeight.w600))),
                Flexible(child: Text('BW:\t\t\t', textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: TextFormField(
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกBW' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกHigh' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
                        ...
                        labelText: 'High'),
                    onSaved: (value) => _high = value,
                  ),
                ),
                Flexible(child: Text(' Cm.')),
                Expanded(
                    flex: 3,
                    child: Text('Last (1,3,6) month:\t\t\t',
                        textAlign: TextAlign.end)),
                Expanded(
                  flex: 2,
                  child: TextFormField(
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกWeight' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    maxLines: 5,
                    validator: (value) {
                      return value.isEmpty ? 'กรุณากรอกPrevious surgery' : null;
                    },
                    decoration: InputDecoration(
                        contentPadding: new EdgeInsets.symmetric(
                            vertical: 8.0, horizontal: 10.0),
                    ...
                    onSaved: (value) => _previousSurgery = value,
                  ),
                ),
              ],
            ),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      title: Text('No'),
                      value: 1,
                      groupValue: antiPlatelet,
                      onChanged: (newValue) {
                        setState(() {
                          antiPlatelet = newValue;
                          _antiPlateletReason = 'No';
                          print(_antiPlateletReason);
                          checkBox3 = false;
                        });
                      },
                    ),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (value) => _antiPlateletReason = value,
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelText: 'Days'),
                    onSaved: (value) => _antiPlateletDays = value,
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      title: Text('No'),
                      value: 1,
                      groupValue: allergyMedication,
                      onChanged: (newValue) {
                        setState(() {
                          allergyMedication = newValue;
                          _allergyMedication = 'No';
                          print(_allergyMedication);
                          checkBox4 = false;
                        });
                      },
                    ),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelText: 'Anti Platelet'),
                    onSaved: (value) => _allergyMedication = value,
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      title: Text('No'),
                      value: 1,
                      groupValue: allergyLatex,
                      onChanged: (newValue) {
                        setState(() {
                          allergyLatex = newValue;
                          _allergyLatex = 'No';
                          print(allergyLatex);
                          checkBox5 = false;
                        });
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      title: Text('Calm'),
                      value: 1,
                      groupValue: psychologicalStatus,
                      onChanged: (newValue) {
                        setState(() {
                          psychologicalStatus = newValue;
                          _psychologicalStatus = 'Calm';
                          print(psychologicalStatus);
                          checkBox6 = false;
                        });
                      },
                    ),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (value) => _psychologicalStatus = value,
                  ),
                ),
              ],
            ),
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      title: Text('No'),
                      value: 1,
                      groupValue: drugAndSubstance,
                      onChanged: (newValue) {
                        setState(() {
                          drugAndSubstance = newValue;
                          _drugAndSubstance = 'No';
                          print(_drugAndSubstance);
                          checkBox7 = false;
                        });
                      },
                    ),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (value) => _drugAndSubstance = value,
                  ),
                ),
                Expanded(
                  flex: 1,
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('Narcotics'),
                      value: 5,
                      groupValue: drugAndSubstance,
                      onChanged: (newValue) {
                        setState(() {
                          drugAndSubstance = newValue;
                          _drugAndSubstance = 'Narcotics';
                          print(_drugAndSubstance);
                          checkBox7 = false;
                        });
                      },
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: Container(
                    child: RadioListTile(
                      ...
                      title: Text('No'),
                      value: 1,
                      groupValue: sleepDisorder,
                      onChanged: (newValue) {
                        setState(() {
                          sleepDisorder = newValue;
                          _sleepDisorder = 'No';
                          print(_sleepDisorder);
                          checkBox8 = false;
                        });
                      },
                    ),
                ...
                Expanded(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (value) => _sleepDisorderDurationAvg = value,
                  ),
                ),
                Expanded(
                    flex: 1,
